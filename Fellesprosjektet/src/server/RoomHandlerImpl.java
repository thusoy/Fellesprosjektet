...
public class RoomHandlerImpl extends Handler implements RoomHandler{
	...
	public Room getRoom(String name) throws IOException {
	...
	public List<Room> availableRooms(Date start, Date end, int capacity) throws IOException {
